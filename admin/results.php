			...
			<div class="ds-main-content">
				...
				<div class="ds-stats-grid" style="margin-bottom: 24px;">
					...
					<div class="ds-stat-card" style="border-top: 4px solid var(--ds-info);">
						...
						<div class="ds-stat-value"><?php echo count($questions); ?></div>
					</div>
				</div>
						...
						<table class="ds-table">
							...
							<tbody>
								<?php if ( empty( $responses ) ) : ?>
									<tr>
										<td colspan="<?php echo count($questions) + 2; ?>">
								...
								<?php else : ?>
									<?php foreach ( $responses as $resp ) : 
										...
										?>
										<tr>
											<td style="color: var(--ds-text-light); font-size: 13px;"><?php echo date_i18n( 'M j, Y H:i', strtotime( $resp['created_at'] ) ); ?></td>
											<td>
