				...
				<form method="post" action="options.php">
					...
					<div class="ds-card">
						...
						<div style="display: flex; flex-direction: column; gap: 24px;">
							<div style="display: flex; justify-content: space-between; align-items: center; padding-bottom: 20px; border-bottom: 1px solid var(--ds-divider);">
								<div>
									<div style="font-weight: 700; color: var(--ds-secondary); font-size: 14px; margin-bottom: 4px;">Anti-Spam Protection</div>
									<div style="font-size: 13px; color: var(--ds-text-light);">Verify submissions to prevent automated spam entries.</div>
								</div>
							...
							<div style="display: flex; justify-content: space-between; align-items: center;">
								<div>
									<div style="font-weight: 700; color: var(--ds-secondary); font-size: 14px; margin-bottom: 4px;">GDPR Compliance</div>
									<div style="font-size: 13px; color: var(--ds-text-light);">Automatically anonymize personal data in responses.</div>
								</div>
								<label class="ds-toggle">
					...
					<div class="ds-card">
						<div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
							...
							<div>
								<h3 style="margin: 0; font-size: 16px; font-weight: 700; color: var(--ds-secondary);">Email Notifications</h3>
								<p style="margin: 4px 0 0; font-size: 12px; color: var(--ds-text-light);">Setup how you want to be notified of new responses.</p>
							</div>
						</div>

						<div style="display: flex; flex-direction: column; gap: 20px;">
							<div>
								<label class="ds-label">Admin Email Address</label>
								<input type="email" name="ds_notify_email" class="ds-input-field" value="<?php echo esc_attr( get_option( 'ds_notify_email' ) ); ?>" placeholder="admin@example.com">
							</div>
							<div style="display: flex; justify-content: space-between; align-items: center; padding-top: 10px;">
								<div>
									<div style="font-weight: 700; color: var(--ds-secondary); font-size: 14px; margin-bottom: 4px;">Instant Email Alerts</div>
									<div style="font-size: 13px; color: var(--ds-text-light);">Send an email immediately when a survey is submitted.</div>
								</div>
								<label class="ds-toggle">
					...
					<div style="padding: 24px; border: 1px solid var(--ds-border); border-radius: var(--ds-radius-md); background: var(--ds-bg); margin-bottom: 48px; display: flex; align-items: center; justify-content: space-between;">
						<div style="display: flex; align-items: center; gap: 16px;">
							...
							<span style="font-size: 14px; font-weight: 600; color: var(--ds-secondary);">System Status: Ready</span>
						</div>
						<?php submit_button( 'Save Settings', 'ds-btn ds-btn-primary', 'submit', false ); ?>
					</div>
				</form>
			</div>
		</div>
